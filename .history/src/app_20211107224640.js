...
class BiliBiliSendBarrage extends EventEmitter {
  ...
  constructor(configs) {
    ...
    BiliBiliSendBarrage.listener = (callback) =>
      super.addListener("callback", callback);

    const requestConfig = {
      protocol: "http:",
      host: "api.live.bilibili.com",
      port: 80,
lllllllllllllllllllllllllllllllllllllllllllllllll        "content-type": `multipart/form-data; boundary=----WebKitFormBoundary8kjTT7jRU64detOB`,
        accept: "*/*",
    ...
    BiliBiliSendBarrage.globalConfigs = Object.assign({
      requestConfig
    }, {
      configs
    });
...
`;
      ...
      const request = BiliBiliSendBarrage.createRequest(
        BiliBiliSendBarrage.globalConfigs.requestConfig
      );

      request.write(data);
      request.end();
    } else BiliBiliSendBarrage.trigger("未提供弹幕内容");
  }
